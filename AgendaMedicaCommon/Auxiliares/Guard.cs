...
namespace AgendaMedicaCommon.Auxiliares
{
    public class Guard
    {
        ...
        public static void ForNullOrEmptyDefaultMessage(string value, string propName)
        {
            if (String.IsNullOrEmpty(value))
                throw new Exception("O Campo " + '"' + propName + '"' + " é obrigatório!");
        }
        public static void ForNullOrEmptyDefaultMessage(decimal value, string propName)
        {
            if (value == null)
                throw new Exception("O Campo " + '"' + propName + '"' + " é obrigatório!");
        }
